...
var AST_DynamicImport = DEFNODE(
  "DynamicImport",
  "phase args",
  function AST_DynamicImport2(props) {
    if (props) {
      this.phase = props.phase;
...
var arg1_is_iterable = /* @__PURE__ */ new Set([
  "Map",
  "Set",
  "WeakMap",
  "WeakSet"
]);
var arg1_is_range_or_iterable = /* @__PURE__ */ new Set([
  "ArrayBuffer",
  "Float32Array",
  "Float64Array",
  "Int16Array",
...
var lone_arg_is_range = /* @__PURE__ */ new Set(["Array"]);
var object_methods = [
  "constructor",
  "toString",
  "valueOf"
...
function is_pure_builtin_call(compressor, call) {
  ...
  if (is_undeclared_ref(exp)) {
    ...
    if (is_undeclared_ref(exp)) {
      if (
        // globalThis.pureFunc()
        exp.name === "globalThis" && compressor.option("builtins_ecma") >= 2020
      ) {
        builtin = method;
        method = "";
      } else {
...
def_eval(AST_Chain, function (compressor, depth) {
  const evaluated = this.expression._eval(
    compressor,
    depth,
    /*ast_chain=*/
    true
  ...
  if (compressor.option("unsafe") && exp instanceof AST_PropAccess) {
    ...
    if (is_undeclared_ref(e)) {
      ...
      val = e._eval(
        compressor,
        depth + 1
        /* don't pass ast_chain (exponential work) */
      );
      if (val === e || !val)
        return this;
